...
title_vect <- paste("Execution times w.r.t the",
                    c("number of nodes (K)", 
...
title_vect <- paste("Reconstruction RMSE at locations w.r.t the",
                    c("number of nodes (K)", 
                      "number of statistical units (N)",
                      "number of locations (S)"))
limits <- NULL
...
title_vect <- paste("Reconstruction IRMSE w.r.t the",
                    c("number of nodes (K)", 
                      "number of statistical units (N)",
                      "number of locations (S)"))
limits <- NULL
...
for(k in 1:3) {
  ...
  title_vect <- paste("Loadings at locations RMSE component", name_vect[k] ,"w.r.t the",
                      c("number of nodes (K)", 
                        "number of statistical units (N)",
                        "number of locations (S)"))
  limits <- NULL
...
for(k in 1:3) {
  ...
  title_vect <- paste("Loadings IRMSE component", name_vect[k] ,"w.r.t the",
                      c("number of nodes (K)", 
                        "number of statistical units (N)",
                        "number of locations (S)"))
  limits <- NULL
...
for(k in 1:3) {
  ...
  title_vect <- paste("Scores RMSE component", name_vect[k] ,"w.r.t the",
                      c("number of nodes (K)", 
                        "number of statistical units (N)",
                        "number of locations (S)"))
  limits <- NULL
...
for(k in 1:3) {
  ...
  title_vect <- paste("Orthogonality check (l2) pair", name_vect[k] ,"w.r.t the",
                      c("number of nodes (K)", 
                        "number of statistical units (N)",
                        "number of locations (S)"))
  limits <- c(80 , 100)
